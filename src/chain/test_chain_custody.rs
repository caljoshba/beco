...
#[test]
fn create_new_keys() {
    let public_user = PublicUser::new("blah blah blah".into());
    let chain_custody: ChainCustody<XRPLKey, XRPLKeyValues> = ChainCustody::new(Blockchain::XRPL, public_user);
...
fn create_new_key() {
    let public_user = PublicUser::new("blah blah blah".into());
    let mut chain_custody: ChainCustody<XRPLKey, XRPLKeyValues> = ChainCustody::new(Blockchain::XRPL, public_user.clone());
